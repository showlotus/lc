...
var fractionAddition = function (expression) {
  ...
  for (let i = 0, len = expression.length; i < len; ) {
    ...
    res = Fraction.computed(res, curr, operator)
...
class Fraction {
  ...
  static computed(f1, f2, operator) {
    const numerator = new Function(
      `return ${f1.numerator * f2.denominator} ${operator} ${
